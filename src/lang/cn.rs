...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("ID/Relay Server", "ID/Relay Configured"),
        ...
        ("Website", "OneDesk云端控制台"),
        ("About", "关于"),
        ("Slogan_tip", "本产品源于 RustDesk 开源项目，向其项目组及所有贡献者致以谢意。"),
        ("Privacy Statement", "RustDesk开源项目"),
        ("Mute", "静音"),
        ("Build Date", "构建日期"),
        ("Version", "版本代号"),
        ("Home", "主页"),
        ...
        ("remote_restarting_tip", "远程设备正在重启, 请稍候重新连接"),
        ("Copied", "已复制"),
        ...
        ("Disconnected", "会话已结束"),
        ("Other", "其他"),
        ("Confirm before closing multiple tabs", "关闭多个会话时向您确认"),
        ...
        ("Hide connection management window", "Hide Connection MGMT"),
         ("Hide Tray", "Hide Tray"),
        ...
        ("relay_hint_tip", "可能无法直连，可以尝试中继连接。\n另外，如果想直接使用中继连接，可以在 ID 后面添加/r，如果历史会话里存在该卡片，也可以在卡片选项里选择强制走中继连接。"),
        ("Reconnect", "重连"),
        ("Codec", "编解码"),
        ("Resolution", "分辨率"),
        ...
        ("Maximize", "最大化"),
        ("Your Device", "你的设备"),
        ("empty_recent_tip", "无历史会话，是时候开始新会话了！"),
        ...
        ("Sync with recent sessions", "同步历史会话"),
        ("Sort tags", "对设备组进行排序"),
        ("Open connection in new tab", "在选项卡中打开新连接"),
        ("Move tab to new window", "将会话移至新窗口"),
        ...
        ("synced_peer_readded_tip", "历史会话中存在的设备将会被重新同步到云端设备。"),
        ("Change Color", "更改颜色"),
        ("Primary Color", "基本色"),
        ("HSV Color", "HSV 色"),
