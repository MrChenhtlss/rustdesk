...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable clipboard", "启用同步剪贴板"),
        ("Enable file transfer", "允许传输文件"),
        ("Enable TCP tunneling", "允许端口映射"),
        ("IP Whitelisting", "IP 白名单"),
        ("ID/Relay Server", "信息化配置"),
        ("Import server config", "导入信息化配置"),
        ("Export Server Config", "导出信息化配置"),
        ("Import server configuration successfully", "导入信息化配置成功"),
        ("Export server configuration successfully", "导出信息化配置成功"),
        ("Invalid server configuration", "信息化配置配置无效，请修改后重新复制配置信息到剪贴板，然后点击此按钮"),
        ("Clipboard is empty", "复制信息化配置到剪贴板后点击此按钮，可以自动导入配置"),
        ("Stop service", "停止服务"),
        ("Change ID", "Change ID"),
        ("Your new ID", "你的新 ID"),
        ...
        ("Website", "灰太狼叔叔在线存储"),
        ("About", "信息详情"),
        ("Slogan_tip", "深表感谢 RustDesk 开发团队及开源社区成员的杰出贡献！"),
        ...
        ("ID Server", "REG Server"),
        ("Relay Server", "Relay Server"),
        ("API Server", "cloud API"),
        ("invalid_http", "格式错误，请检查！"),
        ("Invalid IP", "无效 IP"),
        ("Invalid format", "无效格式"),
        ("server_not_support", "请求云端被拒"),
        ("Not available", "不可用"),
        ...
        ("Unblock user input", "允许用户操作"),
        ("Adjust Window", "自动调节窗口"),
        ("Original", "原始比例"),
        ("Shrink", "收缩"),
        ("Stretch", "伸展"),
        ("Scrollbar", "滚动条"),
        ...
        ("not_close_tcp_tip", "请在使用端口映射时，不要关闭本窗口"),
        ("Listening ...", "正在等待隧道连接..."),
        ("Remote Host", "远程主机"),
        ("Remote Port", "远程端口"),
        ("Action", "动作"),
        ...
        ("setup_server_tip", "基于RustDesk开源项目构建，灰太狼叔叔运营并提供支持！"),
        ...
        ("Dismiss", "拒绝"),
        ("Disconnect", "断开连接"),
        ("Enable file copy and paste", "允许远程拷贝文件"),
        ("Connected", "已连接"),
        ...
        ("Logging in...", "正在登录..."),
        ("Enable RDP session sharing", "允许 RDP 远程接入"),
        ("Auto Login", "自动登录（设置断开后锁定才有效）"),
        ("Enable direct IP access", "允许 IP 访问"),
        ("Rename", "重命名"),
        ("Space", "空格"),
        ...
        ("Favorites", "本地收藏"),
        ("Add to Favorites", "加入本地收藏"),
        ("Remove from Favorites", "从本地收藏中删除"),
        ("Empty", "空空如也"),
        ...
        ("Disconnected", "会话已结束"),
        ("Other", "其他"),
        ("Confirm before closing multiple tabs", "关闭多个设备页时向您确认"),
        ...
        ("Maximize", "最大化"),
        ("Your Device", "你的设备"),
        ("empty_recent_tip", "无历史访问，是时候开始新会话了！"),
        ("empty_favorite_tip", "还没有收藏的被控端？找一个人连接并将其添加到收藏吧！"),
        ("empty_lan_tip", "未发现任何被控端！"),
        ("empty_address_book_tip", "似乎目前云端设备内无被控端"),
        ("eg: admin", "例如：admin"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("New RDP", "新 RDP 连接"),
        ("Fingerprint", "信令"),
        ("Copy Fingerprint", "复制信令"),
        ("no fingerprints", "没有信令"),
        ...
        ("Move tab to new window", "将设备组页移至新窗口"),
        ...
        ("synced_peer_readded_tip", "最近会话中存在的设备将会被重新同步到云端设备。"),
        ("Change Color", "更改颜色"),
        ("Primary Color", "基本色"),
        ("HSV Color", "HSV 色"),
        ...
        ("Remove wallpaper during incoming sessions", "被控时移除桌面壁纸"),
        ("Test", "测试"),
        ...
        ("Enable blocking user input", "允许用户输入"),
