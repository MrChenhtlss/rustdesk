...
pub const PUBLIC_RS_PUB_KEY: &str = "B6j0IYZrdkQfp2ATMciD0QFz14xaBMQIWamCiV12u3Q="; //连接key
...
pub const RENDEZVOUS_PORT: i32 = 21116; //ID服务器默认端口
pub const RELAY_PORT: i32 = 21117; //中继服务器默认端口
